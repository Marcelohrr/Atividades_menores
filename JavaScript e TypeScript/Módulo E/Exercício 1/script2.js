...
botao.addEventListener('click', function () { return contar(box); });
/*
...
function contar(container) {
    const inputInicio = document.querySelector('input#txtnI');
    const inputFim = document.querySelector('input#txtnF');
    const inputPasso = document.querySelector('input#txtnP');
